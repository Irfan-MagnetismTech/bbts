<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu">
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu {{ request()->routeIs(['users.*', 'roles.*', 'permissions.*', 'brands.*', 'branchs.*', 'pops.*']) ? 'active pcoded-trigger' : null }}">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="{{ request()->routeIs('branchs.*') ? 'active' : null }}">
                        <a href="{{ route('branchs.index') }}"> <span class="pcoded-micon"><i class="ti-angle-right"></i></span><span class="pcoded-mtext">Branches</span><span class="pcoded-mcaret"></span></a>
                    </li>
                    <li class="{{ request()->routeIs('pops.*') ? 'active' : null }}">
                        <a href="{{ route('pops.create') }}"> <span class="pcoded-micon"><i class="ti-angle-right"></i></span><span class="pcoded-mtext">POP</span><span class="pcoded-mcaret"></span></a>
                    </li>
                </ul>
            </li>
            {{-- @endhasanyrole --}}
            ...
            <li class="pcoded-hasmenu {{ request()->routeIs(['branches.*', 'apsections.*', 'teams.*', 'departments.*', 'designations.*', 'employees.*', 'sellCollectionHeads.*']) ? 'active pcoded-trigger' : null }}">
                ...
                <ul class="pcoded-submenu">
                    ...
                    {{-- <li class="{{ request()->routeIs('departments.*') ? 'active' : null }}"><a href="{{ route('departments.index') }}"><span class="pcoded-micon"><i class="icon-pie-chart"></i></span><span class="pcoded-mtext"> Departments </span><span class="pcoded-mcaret"></span></a>
            </li> --}}
