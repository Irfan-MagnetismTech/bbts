        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="icon-btn">
                        <nobr>
                            <a href="{{ route('lead-generation.show', $lead_generation->id) }}" data-toggle="tooltip" title="Details" class="btn btn-outline-primary"><i class="fas fa-eye"></i></a>

                            <a href="{{ route('lead-generation.edit', $lead_generation->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-outline-warning"><i class="fas fa-pen"></i></a>

                            <form action="{{ route('lead-generation.destroy', $lead_generation->id) }}" method="POST" data-toggle="tooltip" title="Delete" class="d-inline">
                                @csrf
                                @method('DELETE')
