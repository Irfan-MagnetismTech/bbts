                    ...
                    @if ($details->costing && $details->costing->saleDetail)
                        <div>
                            ...
                            <table class="table table-bordered" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th colspan="9" class="text-center"
                                            style="background-color: #024FA7; color: white">
                                ...
                                <tfoot>
                                    <tr class="text-right"
                                        style="font-weight: bold!important; background-color: #e3ecf6d8!important; ">
                                        <td colspan="4">Total</td>
                                        <td class="text-right" style="border:1px solid black">
                                            {{ number_format($details->costing->costingProducts->sum('sub_total'), 2) }}
                                        </td>
                                        <td class="text-right">{{ number_format($details->costing->costingProducts->sum('operation_cost'), 2) }}
                                        </td>
                                        <td class="text-right">{{ number_format($details->costing->costingProducts->sum('operation_cost_total'), 2) }}
                                        </td>
                                        <td class="text-right"></td>
                                        <td class="text-right">{{ number_format($product_grand_total, 2) }}</td>
                                ...
                                <table class="table table-bordered" style="width: 100%">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th style="background-color:#057097; color: white">Transmission Capacity
                                    ...
                                    <tbody>
                                        ...
                                        @if ($details->costing->costingProductEquipments()->exists())
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    {{ $details->offerDetail->product_equipment_price }}</td>
