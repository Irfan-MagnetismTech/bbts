...
@php
    ...
    $form_heading = 'Update';
    $form_url = route('costing-modification.update', $costing->id);
    $form_method = 'PUT';
@endphp
...
@section('breadcrumb-button')
    <a href="{{ route('costing-modification.index') }}" class="btn btn-out-dashed btn-sm btn-warning"><i class="fas fa-database"></i></a>
@endsection
