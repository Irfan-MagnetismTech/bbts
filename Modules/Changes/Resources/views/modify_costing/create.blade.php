...
@section('breadcrumb-title')
    {{ ucfirst($form_heading) }} Costing Sheet Modification Request
@endsection

@section('breadcrumb-button')
    <a href="{{ route('costing-modification.index') }}" class="btn btn-out-dashed btn-sm btn-warning"><i
    ...
    <script>
        ...
        $('#management_perchantage').on('keyup', function() {
            ...
            $('.product_rate').each(function() {
                ...
                console.log('product_margin_rate', product_margin_rate);
