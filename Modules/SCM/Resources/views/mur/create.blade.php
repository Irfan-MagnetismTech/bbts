...
@php
    ...
    $date = $date instanceof \Carbon\Carbon ? $date->format('d-m-Y') : date('d-m-Y', strtotime($date));
        ...
        <div class="row">
            ...
            <div class="form-group col-3 client_address client">
                ...
                <input type="text" class="form-control" id="client_address" name="client_address"
                       aria-describedby="client_address"
            ...
            <div class="form-group col-3 pop_address pop">
                ...
                <input type="text" class="form-control" id="pop_address" name="pop_address"
                       aria-describedby="pop_address"
        ...
        <table class="table table-bordered" id="material_requisition">
            ...
            @if($formType == 'create')
                ...
                @foreach ($challanLines as $item)
                    ...
                    <tr>
                        <td>
                            <input type="material_name" name="material_name[]" class="form-control type_no"
                                   autocomplete="off" value="{{ $item['material_name'] }}">
                            <input type="hidden" name="material_id[]" class="form-control material_id"
                                   autocomplete="off" value="{{ $item['material_id'] }}">
                            <input type="hidden" name="receiveable_type[]" class="form-control receiveable_type"
                                   autocomplete="off" value="{{ $item['receiveable_type'] }}">
                            <input type="hidden" name="receiveable_id[]" class="form-control receiveable_id"
                                   autocomplete="off" value="{{ $item['receiveable_id'] }}">
                        </td>
                        <td class="form-group">
                            <input type="text" name="description[]" class="form-control description">
                        </td>
                        <td>
                            <input type="text" name="item_code[]" class="form-control item_code" readonly
                        ...
                        <td>
                            <input type="text" name="brand_name[]" class="form-control brand_name" readonly
                                   value="{{ $item['brand_name'] }}">
                            <input type="hidden" name="brand_id[]" class="form-control brand_id" readonly
                                   value="{{ $item['brand_id'] }}">
                        </td>
                        <td>
                        ...
                        <td>
                            <input name="serial_code[]" class="form-control serial_code" autocomplete="off" readonly
                                   value="{{ $item['serial_code'] }}">
                        </td>
                        <td>
                            <input name="quantity[]" class="form-control quantity" autocomplete="off" readonly
                                   value="{{ $item['quantity'] }}">
                        </td>
                        ...
                        <td>
                            <input name="utilized_quantity[]" class="form-control utilized_quantity" readonly
                                   autocomplete="off" value="{{ $item['quantity'] }}">
                        </td>
                        <td>
                ...
                @foreach ($material_name as $key => $item)
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="receiveable_type[]" class="form-control receiveable_type"
                                   autocomplete="off" value="{{ $receiveable_type[$key] }}">
                            <input type="hidden" name="receiveable_id[]" class="form-control receiveable_id"
                        ...
                        <td>
                            <input name="bbts_ownership[]" class="form-control bbts_ownership" autocomplete="off"
                                   value="{{ $bbts_ownership[$key] }}">
                        </td>
                        <td>
                            <input name="client_ownership[]" class="form-control client_ownership" autocomplete="off"
                                   value="{{ $client_ownership[$key] }}">
                        </td>
                        <td>
                            <input name="utilized_quantity[]" class="form-control utilized_quantity" readonly
                                   autocomplete="off" value="{{ $utilized_quantity[$key] }}">
                        </td>
                        <td>
                            <input class="form-control remarks" name="remarks[]" aria-describedby="remarks"
                                   value="{{ $remarks[$key] }}">
