    ...
    <div class="row">
        ...
        <div class="form-group col-4">
            ...
            <select class="form-control" name="po_type" id="po_type" required>
                ...
                <option value="Purchase Order" @selected(
                'Purchase Order' == @$purchaseOrder->po_type)>Purchase Order</option>
                <option value="Work Order" @selected(
                'Work Order' == @$purchaseOrder->po_type)>Work Order</option>
            </select>
        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.error) {
                                ...
                                $('#indent_no').val(data[0].label);
                                $('#indent_id').val(data[0].value);
                            }
                        },
