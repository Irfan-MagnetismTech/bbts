    ...
    <li class="pcoded-hasmenu {{ request()->routeIs(['requisitions.*']) ? 'active pcoded-trigger' : null }}">
        ...
        <ul class="pcoded-submenu">
            <li class="{{ request()->routeIs('requisitions.create') ? 'active' : null }}">
                <a href="{{ route('requisitions.create') }}"> <span class="pcoded-micon"><i class="ti-angle-right"></i></span><span class="pcoded-mtext">Create New</span><span class="pcoded-mcaret"></span></a>
            </li>
    ...
    <li class="pcoded-hasmenu {{ request()->routeIs(['purchase-requisitions.*']) ? 'active pcoded-trigger' : null }}">
        ...
        <ul class="pcoded-submenu">
            <li class="{{ request()->routeIs('purchase-requisitions.create') ? 'active' : null }}">
                <a href="{{ route('purchase-requisitions.create') }}"> <span class="pcoded-micon"><i class="ti-angle-right"></i></span><span class="pcoded-mtext">Create New</span><span class="pcoded-mcaret"></span></a>
            </li>
