            ...
            <div class="card">
                    ...
                    <div class="row">
                        @php
                            ...
                            if ($is_old) {
                                ...
                                $collectionLines = $collection->collectionLines ?? null;

                                if ($collectionLines) {
                                    foreach ($collectionLines as $collectionLine) {
                                        $bank_names[] = $collectionLine->bank_name;
                                    }
                                }
                            }
                            $instrument_date = old('instrument_date', !empty($collection) ? $collection->collectionLines->pluck('instrument_date') : []);
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                @if (!empty($collection))
                                    @foreach ($collection->lines as $key => $item)
                                        <tr class="payment_details_row">
                                            <td>
                                                <div class="input-group input-group-sm input-group-primary">
                                                    <select name="payment_method[]" class="form-control"
                                                        ...
                                                        <option value="bank"
                                                                @if ($item->payment_method == 'bank') Selected @endif>
                                                            BANK
                                                        </option>
                                                        <option value="cash"
                                                        ...
                                                        <option value="bkash"
                                                                @if ($item->payment_method == 'bkash') Selected @endif>
                                                            BKASH
                                                        </option>
                                                        <option value="nogod"
                                                                @if ($item->payment_method == 'nogod') Selected @endif>
                                                            NAGAD
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm input-group-primary">
                                                <select name="bank_name[]" class="form-control bank_name select2"
                                                        autocomplete="off">
                                                    <option value="">Select Bank</option>
                                                    @foreach ($banks as $bank)
                                                        <option value="{{ $bank->name }}" @selected($bank->name ==
                                                            $bank_names[$key])>
                                                            {{ $bank->name }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm input-group-primary">
                                                    <input type="date" name="instrument_date[]" class="form-control"
                                ...
                                @else
                                    <tr class="payment_details_row">
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm input-group-primary">
                                                <input type="date" name="instrument_date[]"
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm input-group-primary">
                                                    <input type="text" name="total[]"
                                                           ...
                                                           autocomplete="off" placeholder="Total"
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm input-group-primary">
                                            <input type="text" name="total_bill_amount" class="form-control"
                                                   ...
                                                   placeholder="Total Bill Amount" value="{{ $total_bill_amount }}"
                                                   readonly>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm input-group-primary">
                                            <input type="text" name="grand_total" class="form-control"
                                                   id="grand_total" autocomplete="off" placeholder="Grand Total"
                                                   readonly
                                                   value="{{ $grand_total }}">
                                        </div>
                                    </td>
                        ...
                        <button
                            class="py-3 px-5 btn btn-success ">{{ !empty($collections->id) ? 'Update' : 'Save' }}</button>
                    </div>
                </div>
                {!! Form::close() !!}
                @endsection
                ...
                @section('script')
                    <script>
                        ...
                        function addRow() {
                            var row = $('.payment_details_row').first().clone();
                            row.find('input').val('');
                            row.find('select').val('');
