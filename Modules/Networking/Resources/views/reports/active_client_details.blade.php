...
@section('title', ' Active Client Details')
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table table-striped table-bordered">
                        ...
                        <tr style="background-color: #0C4A77;color: white">
                            ...
                            <td> <strong>{{ $salesDetail->client->client_name ?? '' }}</strong></td>
                        </tr>
                        <tr>
                            <td> <strong>Connectivity Point</strong> </td>
                            <td> {{ $salesDetail->frDetails->connectivity_point ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Contact Person</strong> </td>
                            <td> {{ $salesDetail->frDetails->contact_name ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Contact Number</strong> </td>
                            <td> {{ $salesDetail->frDetails->contact_number ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Designation</strong> </td>
                            <td> {{ $salesDetail->frDetails->contact_designation ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Email</strong> </td>
                            <td> {{ $salesDetail->frDetails->contact_email ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Latitude</strong> </td>
                            <td> {{ $salesDetail->frDetails->lat ?? '' }}</td>
                        </tr>
                        <tr>
                            <td> <strong>Longitude</strong> </td>
                            <td> {{ $salesDetail->frDetails->long ?? '' }}</td>
                        </tr>
                        <tr>
