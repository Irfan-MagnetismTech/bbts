                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-info">
                                <a href="{{ route('logical-internet-connectivities.create', ['physical_connectivity_id' => $physicalConnectivity->id, 'type' => 'internet']) }}"
                            ...
                            <span class="badge badge-info">
                                <a href="{{ route('logical-vas-connectivities.create', ['physical_connectivity_id' => $physicalConnectivity->id, 'type' => 'vas']) }}"
