...
@section('content')
    @php
        $vasServices = !empty($vasServices) ? $vasServices->lines : $saleDetails->saleProductDetails;
    @endphp
    ...
    <div class="">
        <form action="{{ route('logical-vas-connectivities.store') }}" method="post" class="custom-form">
            ...
            <div class="row">
                ...
                <div class="form-group col-3 client_name">
                    ...
                    <input type="text" class="form-control" id="client_name" aria-describedby="client_name"
                        name="client_name" value="{{ $saleDetails->client->client_name }}" readonly>
                    <input type="hidden" name="client_no" id="client_no" value="{{ $saleDetails->client_no }}">
                </div>

                <div class="form-group col-3 client_type">
                    <label for="client_type">Client Type:</label>
                    <input type="text" class="form-control" id="client_type" name="client_type"
                        aria-describedby="client_type" readonly value="{{ $saleDetails->client->client_type }}">
                </div>
                ...
                <div class="form-group col-3 connectivity_point1">
                    ...
                    <input type="text" class="form-control" id="connectivity_point1" name="connectivity_point1"
                        ...
                        value="{{ $saleDetails->frDetails->connectivity_point . '_' . $saleDetails->frDetails->fr_no }}"
                        readonly>
                    <input type="hidden" name="fr_no" id="fr_no" value="{{ $saleDetails->frDetails->fr_no }}">
                </div>

                <div class="form-group col-3 contact_person">
                    <label for="contact_person">Contact Person:</label>
                    <input type="text" class="form-control" id="contact_person" name="contact_person"
                        aria-describedby="contact_person" readonly value="{{ $saleDetails->frDetails->contact_name }}">
                </div>
                ...
                <div class="form-group col-3 contact_number">
                    ...
                    <input type="text" class="form-control" id="contact_number" aria-describedby="contact_number"
                        name="contact_number" readonly value="{{ $saleDetails->frDetails->contact_number }}">
                </div>

                <div class="form-group col-3 email">
                    <label for="email">Email:</label>
                    <input type="text" class="form-control" id="email" name="email" aria-describedby="email"
                        readonly value="{{ $saleDetails->frDetails->contact_email }}">
                </div>
                ...
                <div class="form-group col-3 contact_address">
                    ...
                    <input type="text" class="form-control" id="contact_address" name="contact_address"
                        ...
                        value="{{ $saleDetails->frDetails->location }}">
                </div>
            ...
            <table class="table table-bordered" id="vas_service">
                ...
                <tbody>
                    {{-- @if (!empty($vasServices)) --}}
                        @foreach ($vasServices as $key => $line)
                            <tr>
                                <td>
            ...
            @if(!empty($physicalConnectivityVas))
